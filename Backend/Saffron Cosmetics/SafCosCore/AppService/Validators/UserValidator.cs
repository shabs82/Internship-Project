...
{
    public class UserValidator : AbstractValidator<LoginInputModel>
    {
        public UserValidator()
        {
            ...
            RuleFor(p => p.Password).MinimumLength(3).WithMessage("password cannot be less than 5 characters");
